...
// const EXPLORER_BACKEND_WAMP_SECRET_ENVVAR: string  = "WAMP_NEAR_EXPLORER_BACKEND_SECRET";
...
// const EXPLORER_FRONTEND_DATA_SOURCE_ENVVAR: string = "NEAR_EXPLORER_DATA_SOURCE";
...
export class NearLambda implements KurtosisLambda {
    ...
    private static async addFrontendService(networkCtx: NetworkContext, wampHostMachinePortBindingOpt?: PortBinding): Promise<Result<[ServiceContext, Map<string, PortBinding>], Error>> {
        ...
        // envVars.set(EXPLORER_FRONTEND_DATA_SOURCE_ENVVAR, EXPLORER_FRONTEND_INDEXER_DATA_SOURCE);
